...
<main class="container catalog-page">
    <section class="catalog-hero">
        <h1>Productos de Filtración</h1>
        <p>Soluciones avanzadas en filtracion industrial para liquidos, gases y particulas. Equipos de alta precision para optimizar procesos y asegurar continuidad operativa.</p>
    </section>
